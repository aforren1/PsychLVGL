/**
 * @file lv_conf.h
 * LVGL configuration for psychlvgl. Generated from the v9.6.0 template by
 * gen/mkconf.py, then committed. See SPEC.md section 10.2 for the rationale
 * behind every value that differs from the template.
 *
 * Two build variants share this file:
 *   default          GPU: LV_USE_OPENGLES + LV_USE_DRAW_NANOVG
 *   PSYCHLVGL_TEST_SW  CPU: LV_USE_DRAW_SW, no GL at all
 */
/**
 * @file lv_conf.h
...
/* clang-format off */
#if 1 /* content enabled by psychlvgl */
...
/* Software rendering is off in the shipping build. The test variant turns it
 * on so the no-GL tests can render without a GPU. */
#ifdef PSYCHLVGL_TEST_SW
...
/* Tracy supplies the zone macros when PSYCHLVGL_TRACY is on. */
#ifdef PSYCHLVGL_TRACY
 ...
 */
#define LV_ASSERT_CUSTOM_INCLUDE "plv_assert.h"
