...
%   opts   Option struct for PsychLVGL('Init'), see help PsychLVGL.
%
%   The returned struct holds win, w, h, dst, tex, glTex, kq and opened.
%   Keep it and give it to PsychLVGLFrame, PsychLVGLGL and PsychLVGLClose.
%
...
%   See also PSYCHLVGLFRAME, PSYCHLVGLGL, PSYCHLVGLCLOSE, PSYCHLVGLSETUP.
    ...
    ui = struct('win', win, 'w', w, 'h', h, 'dst', dst(:)', ...
                'tex', tex, 'glTex', glTex, 'kq', kq, 'opened', true, ...
                'tLast', plv_now());
end
