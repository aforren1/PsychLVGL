function [s, img] = psychlvgl_gabor_std(win, rect)
% PSYCHLVGL_GABOR_STD  Pixel standard deviation of a region of the back buffer.
%   A copy of tests/gl/gabor_std for the demos, in m/private so that a
%   release package runs them without a path change.
%
%   [s, img] = psychlvgl_gabor_std(win, rect)
%
