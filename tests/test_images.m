...
%   the texture pixels on the GPU build.
    ...
    t2 = PsychLVGL('ImageFromTexture', 8, 40, 12, true);
    PsychLVGL('ImageSetSrc', obj, t2);
    plv_eq('a transposed texture image has the shown size', ...
           [PsychLVGL('ImageGetSrcWidth', obj), PsychLVGL('ImageGetSrcHeight', obj)], [40 12]);
    PsychLVGL('ImageSetSrc', obj, t);
    PsychLVGL('ImageDelete', t2);
